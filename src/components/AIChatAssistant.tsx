      ...
      <AnimatePresence>
        {isOpen && (
          <motion.div
            ...
            className="fixed bottom-28 left-8 w-[90vw] md:w-[400px] h-[600px] max-h-[70vh] z-[100] glass-panel border border-white/10 rounded-3xl shadow-[0_20px_80px_rgba(0,0,0,0.6)] flex flex-col overflow-hidden backdrop-blur-2xl"
          >
            {/* Header */}
