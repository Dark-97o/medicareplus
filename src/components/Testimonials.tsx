      ...
      <div className="container mx-auto px-8 md:px-16">
        <div className="flex flex-col md:flex-row justify-between items-end mb-3 gap-6">
          <div className="max-w-xl">
            <p className="text-(--color-accent-blue) font-mono text-[0.6rem] uppercase tracking-[0.4em] mb-2">Patient Perspectives</p>
            <h2 className="font-serif text-2xl md:text-3xl font-black uppercase tracking-tight leading-[1.1] mb-2">
              Real Patients <br />
