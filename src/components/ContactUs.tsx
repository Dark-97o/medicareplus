      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-start">
        ...
        >
          <div className="inline-flex items-center gap-2 mb-4 px-3 py-1.5 rounded-full border border-(--color-accent-purple)/30 bg-(--color-accent-purple)/10">
            ...
            <span className="font-mono text-[0.6rem] uppercase tracking-widest text-(--color-accent-purple)">Get In Touch</span>
          </div>
          ...
          <p className="text-gray-200 max-w-lg mb-10 leading-relaxed text-sm md:text-base font-medium">
          ...
          <div className="space-y-6">
            <div className="flex items-start gap-4 group">
              ...
              <div>
                <p className="font-mono text-[0.55rem] uppercase tracking-widest text-gray-400 mb-0.5">Emergency 24x7</p>
                <p className="text-lg font-serif font-bold text-white">+91 141 222 3344</p>
              </div>
            </div>
            ...
            <div className="flex items-start gap-4 group">
              ...
              <div>
                <p className="font-mono text-[0.55rem] uppercase tracking-widest text-gray-400 mb-0.5">Email Support</p>
                <p className="text-lg font-serif font-bold text-white">care@medicareplus.com</p>
              </div>
            </div>
          </div>
        </motion.div>
        ...
        >
          ...
          {isSuccess ? (
            ...
            >
              ...
              <h3 className="text-xl font-serif font-bold text-white mb-2">Message Sent Successfully</h3>
              <p className="text-(--color-text-muted) max-w-xs mx-auto text-xs">Thank you for reaching out. We've received your inquiry and will respond via email shortly.</p>
              <button 
            ...
            <form onSubmit={handleSubmit} className="space-y-4 relative z-10">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div className="space-y-1.5">
                  <label className="text-[9px] font-mono uppercase tracking-[0.2em] text-gray-400 ml-1">Full Name</label>
                ...
                <div className="space-y-1.5">
                  <label className="text-[9px] font-mono uppercase tracking-[0.2em] text-gray-400 ml-1">Phone Number</label>
                  <div className="relative">
              ...
              <div className="space-y-1.5">
                <label className="text-[9px] font-mono uppercase tracking-[0.2em] text-gray-400 ml-1">Email Address</label>
                <div className="relative">
              ...
              <div className="space-y-1.5">
                <label className="text-[9px] font-mono uppercase tracking-[0.2em] text-gray-400 ml-1">Message</label>
                <div className="relative">
